...
| `Everything-SDK-3.0.0.9/` | Everything 3.0 SDK：`include/Everything3.h`、导入库 `lib/`、运行时 `dll/` 与示例 `sdk3.test.c` | voidtools 发布，见 <https://www.voidtools.com/> |
...
| `Everything-SDK-3.0.0.9/` | Everything 3.0 SDK: `include/Everything3.h`, import libraries in `lib/`, runtime DLLs in `dll/`, and the `sdk3.test.c` example | Distributed by voidtools, see <https://www.voidtools.com/> |
